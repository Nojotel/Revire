document.addEventListener("DOMContentLoaded", function () {
  ...
  let closeButton = document.querySelector(".close-button--menu");
...
document.addEventListener("DOMContentLoaded", function () {
  const nameInput = document.getElementById("mob_name");
  const telInput = document.getElementById("mob_tel");
  ...
  const formSendButton = document.getElementById("mob_formSend");
  formSendButton.addEventListener("click", openModal);

  window.addEventListener("mousedown", function (event) {
    const modal = document.getElementById("mob_modal");
...
function closeModal() {
  ...
  if (modal.style.display === "block") {
    ...
    document.getElementById("mob_tel").value = "";

    //removeErrorMessage(document.getElementById("mob_name"));
    // removeErrorMessage(document.getElementById("mob_tel"));
  }
}
